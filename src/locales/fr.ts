...
const fr: Catalog = {
  ...
  'common.undo': 'Annuler',
  'item.removedToast': '{name} retiré',
  'sort.buttonLabel': 'Trier et filtrer',
  'sort.buttonLabelFiltered': 'Trier et filtrer (filtré)',
  'sort.heading': 'Ordre',
  'sort.added.label': 'Par ajout',
  'sort.added.hint': 'Les plus récents en bas',
  'sort.aisle.label': 'Par rayon',
  'sort.aisle.hint': "Dans l'ordre du magasin",
  'aisle.produce': 'Fruits et légumes',
  'aisle.bakery': 'Boulangerie',
  'aisle.dairy': 'Produits laitiers et œufs',
  'aisle.meat': 'Viande et poisson',
  'aisle.prepared': 'Surgelés et plats préparés',
  'aisle.pantry': 'Épicerie',
  'aisle.sweets': 'Sucreries et snacks',
  'aisle.drinks': 'Boissons',
  'aisle.household': 'Maison',
  'aisle.personal': 'Soins personnels',
  'aisle.other': 'Autres',
  'list.cart.heading': 'Dans le panier',
  'list.meta.allPicked': 'Tout est dans le panier',
  'list.buyBar.slideHint': 'Glissez pour terminer',
  'add.addTyped': 'Ajouter « {name} »',
  'add.addTypedHint': "Tel que vous l'avez écrit",
  'add.noteOffline': 'Vous êtes hors ligne. Voici vos achats précédents.',
  'add.noteDegraded': 'Certains magasins sont injoignables. Des produits peuvent manquer.',
  'household.roleOwner': 'Propriétaire',
  'household.roleModerator': 'Modérateur',
  'household.you': 'Vous',
  'household.aloneHint': "Vous êtes seul pour l'instant. Invitez quelqu'un et vous verrez tous deux la liste changer en direct.",
  'household.open': '{name} : membres, inviter, changer de foyer',
  ...
  'history.readded': '{name} est de nouveau sur la liste',
  'sync.offline': 'Hors ligne',
  'sync.reconnecting': 'Reconnexion',
  'realtime.checkedOut': { one: "{n} article a été validé sur un autre appareil", other: "{n} articles ont été validés sur un autre appareil" },
  'history.addTrip': 'Tout ajouter',
  'history.addTripLabel': { one: "Remettre sur la liste {n} article de ces courses", other: "Remettre sur la liste les {n} articles de ces courses" },
  'history.tripReadded': 'Ces courses sont de nouveau sur la liste',
