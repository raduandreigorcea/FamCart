...
const fr: Catalog = {
  ...
  'householdBar.toBuy': { one: '{n} à acheter', other: '{n} à acheter' },
  'householdBar.inCart': { one: '{n} dans le panier', other: '{n} dans le panier' },
  ...
  'switcher.hint': 'La liste que vous consultez',
