...
const de: Catalog = {
  ...
  'household.roleOwner': 'Inhaber',
  'household.roleModerator': 'Moderator',
  'household.you': 'Du',
  'household.aloneHint': 'Bisher nur du. Lade jemanden ein, dann seht ihr beide jede Änderung sofort.',
  'household.open': '{name}: Mitglieder, einladen, Haushalt wechseln',
