...
const es: Catalog = {
  ...
  'item.removedToast': '{name} quitado',
  'sort.buttonLabel': 'Ordenar y filtrar',
  'sort.buttonLabelFiltered': 'Ordenar y filtrar (filtrado)',
  'sort.heading': 'Orden',
  'sort.added.label': 'Como se añadió',
  'sort.added.hint': 'Lo más nuevo abajo',
  'sort.aisle.label': 'Por pasillo',
  'sort.aisle.hint': 'En el orden de la tienda',
  'aisle.produce': 'Frutas y verduras',
  'aisle.bakery': 'Panadería',
  'aisle.dairy': 'Lácteos y huevos',
  'aisle.meat': 'Carne y pescado',
  'aisle.prepared': 'Congelados y platos preparados',
  'aisle.pantry': 'Despensa',
  'aisle.sweets': 'Dulces y snacks',
  'aisle.drinks': 'Bebidas',
  'aisle.household': 'Hogar',
  'aisle.personal': 'Cuidado personal',
  'aisle.other': 'Otros',
  'list.cart.heading': 'En el carrito',
  'list.meta.allPicked': 'Todo está en el carrito',
  'list.buyBar.slideHint': 'Desliza para terminar',
  'add.addTyped': 'Añadir «{name}»',
  'add.addTypedHint': 'Tal como lo escribiste',
  'add.noteOffline': 'Sin conexión. Mostrando lo que ya habéis comprado.',
  'add.noteDegraded': 'No se pudo consultar todas las tiendas. Pueden faltar productos.',
  'household.roleOwner': 'Propietario',
  'household.roleModerator': 'Moderador',
  'household.you': 'Tú',
  'household.aloneHint': 'Por ahora solo tú. Invita a alguien y los dos veréis la lista cambiar al instante.',
  'household.open': '{name}: miembros, invitar, cambiar de hogar',
  ...
  'history.readded': '{name} vuelve a estar en la lista',
  'sync.offline': 'Sin conexión',
  'sync.reconnecting': 'Reconectando',
  'realtime.checkedOut': { one: "{n} producto se finalizó en otro dispositivo", other: "{n} productos se finalizaron en otro dispositivo" },
  'history.addTrip': 'Añadir todo',
  'history.addTripLabel': { one: "Volver a añadir a la lista {n} producto de esta compra", other: "Volver a añadir a la lista los {n} productos de esta compra" },
  'history.tripReadded': 'Esta compra vuelve a estar en la lista',
