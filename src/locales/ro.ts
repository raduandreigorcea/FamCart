...
const ro: Catalog = {
  ...
  'list.buyBar.slide': {
    one: 'Glisează: {n} produs cumpărat',
    few: 'Glisează: {n} produse cumpărate',
    other: 'Glisează: {n} de produse cumpărate',
  },
  'list.buyBar.checkOut': {
    one: 'Marchează {n} produs ca cumpărat',
    few: 'Marchează {n} produse ca cumpărate',
    other: 'Marchează {n} de produse ca cumpărate',
  },
  ...
  'history.title': 'Istoricul cumpărăturilor',
  'history.subtitle': 'Cumpărăturile tale recente',
  'history.close': 'Închide istoricul',
  'history.empty': 'Încă nu ați făcut cumpărături. Produsele cumpărate vor apărea aici.',
  'history.you': 'Tu',
  ...
  'error.checkoutFailed': 'Cumpărăturile nu au putut fi încheiate.',
  ...
  'item.removedToast': 'Ai scos {name}',
  'sort.buttonLabel': 'Ordine și filtru',
  'sort.buttonLabelFiltered': 'Ordine și filtru (filtrat)',
  'sort.heading': 'Ordine',
  'sort.added.label': 'Cum au fost adăugate',
  'sort.added.hint': 'Cele noi la final',
  'sort.aisle.label': 'Pe raioane',
  'sort.aisle.hint': 'În ordinea în care treci prin magazin',
  'aisle.produce': 'Fructe și legume',
  'aisle.bakery': 'Brutărie',
  'aisle.dairy': 'Lactate și ouă',
  'aisle.meat': 'Carne și pește',
  'aisle.prepared': 'Congelate și gata preparate',
  'aisle.pantry': 'Băcănie',
  'aisle.sweets': 'Dulciuri și snacks-uri',
  'aisle.drinks': 'Băuturi',
  'aisle.household': 'Casă și curățenie',
  'aisle.personal': 'Îngrijire personală',
  'aisle.other': 'Altele',
  'list.cart.heading': 'În coș',
  'list.meta.allPicked': 'Totul e în coș',
  'list.buyBar.slideHint': 'Glisează spre dreapta',
  'add.addTyped': 'Adaugă „{name}”',
  'add.addTypedHint': 'Exact cum l-ai scris',
  'add.noteOffline': 'Nu ești conectat. Vezi ce ați mai cumpărat.',
  'add.noteDegraded': 'Nu am putut verifica toate magazinele. Pot lipsi unele produse.',
  'household.roleOwner': 'Proprietar',
  'household.roleModerator': 'Moderator',
  'household.you': 'Tu',
  'household.aloneHint': 'Deocamdată doar tu. Invită pe cineva și veți vedea amândoi lista schimbându-se pe loc.',
  'household.open': '{name}: membri, invitații, schimbă gospodăria',
  ...
  'history.readded': '{name} e din nou pe listă',
  'sync.offline': 'Offline',
  'sync.reconnecting': 'Se reconectează',
  'realtime.checkedOut': { one: "{n} produs a fost marcat ca cumpărat pe alt dispozitiv", few: "{n} produse au fost marcate ca cumpărate pe alt dispozitiv", other: "{n} de produse au fost marcate ca cumpărate pe alt dispozitiv" },
  'history.addTrip': 'Adaugă tot',
  'history.addTripLabel': { one: "Adaugă din nou pe listă {n} produs din această tură", few: "Adaugă din nou pe listă cele {n} produse din această tură", other: "Adaugă din nou pe listă cele {n} de produse din această tură" },
  'history.tripReadded': 'Tura aceasta e din nou pe listă',
