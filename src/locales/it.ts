...
const it: Catalog = {
  ...
  'householdBar.toBuy': { one: '{n} da comprare', other: '{n} da comprare' },
  'householdBar.inCart': { one: '{n} nel carrello', other: '{n} nel carrello' },
  ...
  'switcher.heading': 'Le tue famiglie',
  'switcher.hint': 'Quale lista stai guardando',
  ...
  'nav.label': 'Azioni principali',
  'nav.household': 'Famiglia',
  'nav.history': 'Cronologia',
  'nav.add': 'Aggiungi',
  'nav.addLabel': 'Aggiungi un articolo',
  'nav.you': 'Tu',
  'nav.switch': 'Cambia',
  'nav.switchLabel': 'Cambia famiglia',
