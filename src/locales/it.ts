...
const it: Catalog = {
  ...
  'error.listNameTooLong': 'Il nome della famiglia deve avere al massimo {max} caratteri.',
  'error.nameRequiredTitle': 'Nome obbligatorio',
  'error.listNameRequired': 'Dai un nome alla tua famiglia prima di salvare.',
  'error.ownOneList':
  ...
  'error.createListFailed': 'Impossibile creare la famiglia.',
  'error.joinListFailed': 'Impossibile unirsi alla famiglia.',
  'error.inviteCodeInvalid':
    'Il codice di invito deve avere 8 caratteri, solo lettere e numeri.',
  'error.noListForCode': 'Nessuna famiglia trovata con quel codice di invito.',
  ...
  'account.manageList': 'Gestisci la famiglia',
  'account.listFallback': 'Famiglia',
  ...
  'list.title': 'Impostazioni della famiglia',
  ...
  'error.leaveListFailed': 'Non è stato possibile lasciare la famiglia.',
  'error.deleteListFailed': 'Non è stato possibile eliminare la famiglia.',
  'error.renameListFailed': 'Non è stato possibile rinominare la famiglia.',
  ...
  'report.surface.settings': 'Famiglia e membri',
  ...
  'error.loadListsFailed': 'Non è stato possibile caricare la tua famiglia.',
  ...
  'list.open': '{name}: membri, invita, cambia famiglia',
