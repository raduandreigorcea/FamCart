...
// names for the same number (MAX_FAMILIES in the topbar, FAMILY_MEMBERSHIP_CAP
...
/** Longest a family name may be. Mirrors 003_families_and_members.sql. */
export const FAMILY_NAME_MAX_LENGTH = 25

/** Longest a shopping-list item name may be. Mirrors 004_shopping_list.sql. */
export const ITEM_NAME_MAX_LENGTH = 120

/** How many families one user may belong to. Mirrors 003_families_and_members.sql. */
export const FAMILY_MEMBERSHIP_CAP = 3

/**
 * Bounds on a family's per-member active-item cap — the owner-configurable
 * setting itself, not the count it limits. Mirrors 003_families_and_members.sql.
 */
 ...
 * "this family may not add anything".
 */
